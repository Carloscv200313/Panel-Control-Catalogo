                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="relative p-8 bg-linear-to-br from-[#26c6da]/10 via-transparent to-transparent border-b border-gray-100 dark:border-white/5">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">Refina los detalles de este producto en tu catálogo.</p>
                        </div>
                    </div>
                                ...
                                <div className="lg:col-span-7 space-y-8">
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-3 text-[#26c6da]">
                                            ...
                                            <h3 className="font-black dark:text-white uppercase tracking-widest text-lg">Información Principal</h3>
                                        </div>

                                        <div className="grid grid-cols-1 gap-6">
                                            <div className="space-y-2 group">
                                                <Label htmlFor="name-edit" className="text-[11px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 flex items-center gap-2 ml-1 group-focus-within:text-[#26c6da] transition-colors">
                                            ...
                                            <div className="space-y-2 group">
                                                <Label htmlFor="desc-edit" className="text-[11px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 flex items-center gap-2 ml-1 group-focus-within:text-[#26c6da] transition-colors">
                                ...
                                <div className="lg:col-span-5 space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative group group/img">
                                            <Label htmlFor="image-edit" className={`relative flex flex-col items-center justify-center w-full ${preview ? 'h-64' : 'h-52'} rounded-[2.5rem] border-2 border-dashed ${preview ? 'border-[#26c6da]/30' : 'border-gray-200 dark:border-white/10'} bg-gray-50/50 dark:bg-white/5 hover:bg-[#26c6da]/5 hover:border-[#26c6da]/50 transition-all cursor-pointer overflow-hidden`}>
                                                {preview ? (
